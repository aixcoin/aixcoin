...
Aixcoin Core includes a GUI built with the cross-platform Qt Framework.
...
You can deploy a `.dmg` containing the Aixcoin Core application using `make deploy`.
...
Aixcoin Core should now be available at `./src/aixcoind`.
