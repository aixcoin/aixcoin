...
Aixcoin Core version 0.21.1 is now available from:

  <https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.21.1/>
...
FAQ](https://aixcoin-core.github.io/aixcoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/aixcoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/aixcoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/aixcoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Aixcoin](https://aixcoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-aixcoin)
  - [What do Schnorr Signatures Mean for Aixcoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-aixcoin)
...
- Development history overview
  - [Taproot](https://aixcoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://aixcoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://aixcoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://aixcoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://aixcoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/aixcoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/aixcoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to aixcoin.conf documentation (jonatack)
