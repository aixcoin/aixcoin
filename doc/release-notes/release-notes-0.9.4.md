Aixcoin Core version 0.9.4 is now available from:

  https://aixcoin.org/bin/0.9.4/
...
this update is incompatible with the Aixcoin system and could lead to consensus
forks.

Aixcoin Core released binaries from https://aixcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~aixcoin/+archive/ubuntu/aixcoin
- A third-party or self-compiled Aixcoin Core

upgrade to Aixcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
