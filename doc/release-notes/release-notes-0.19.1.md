...
Aixcoin Core version 0.19.1 is now available from:

  <https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.19.1/>
...
From Aixcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
...
- #17488 fix "aixcoind already running" warnings on macOS (fanquake)
