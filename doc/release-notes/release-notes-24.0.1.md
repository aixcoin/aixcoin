...
This version of Aixcoin Core adds a new `mempoolfullrbf` configuration
...
Some Aixcoin services today expect that the first version of an
...
The Aixcoin Protocol does not, and cannot, provide any assurance that
...
fees, was realized in [Aixcoin Core 0.12.0][] (February 2016) with the
...
[Aixcoin Core 0.12.0]: https://aixcoincore.org/en/releases/0.12.0/#opt-in-replace-by-fee-transactions
...
- To help prevent fingerprinting transactions created by the Aixcoin Core wallet, change output
