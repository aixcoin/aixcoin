Aixcoin Core version 0.16.1 is now available from:

  <https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting aixcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure aixcoind processes are cleaned up when tests end (sdaftuar)
