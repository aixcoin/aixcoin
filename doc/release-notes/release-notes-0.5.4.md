Aixcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/aixcoin/files/Aixcoin/aixcoin-0.5.4/
...
http://gitorious.org/aixcoin/aixcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Aixcoin-Qt notifications under Growl 1.3.
Increase required age of Aixcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAixcoin properly when installing Aixcoin-Qt over it. (Windows)
