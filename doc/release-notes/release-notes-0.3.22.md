Download URL: https://sourceforge.net/projects/aixcoin/files/Aixcoin/aixcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 AIX fee schedule (users still pay 0.01 AIX per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #aixcoin00 - #aixcoin99
