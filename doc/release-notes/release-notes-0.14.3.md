Aixcoin Core version *0.14.3* is now available from:

  <https://aixcoin.org/bin/aixcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/aixcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
