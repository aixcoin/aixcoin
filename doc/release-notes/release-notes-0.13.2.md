Aixcoin Core version 0.13.2 is now available from:

  <https://aixcoin.org/bin/aixcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update aixcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow aixcoin-tx to create v2 transactions (aixdrak)
