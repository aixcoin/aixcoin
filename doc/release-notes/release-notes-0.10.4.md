Aixcoin Core version 0.10.4 is now available from:

  <https://aixcoin.org/bin/aixcoin-core-0.10.4/>
...
- #6953 `43c2789` Split aixcoin-tx into its own package
- #6953 `dfe0d4d` Include aixcoin-tx binary on Debian/Ubuntu
