Aixcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/aixcoin/files/Aixcoin/aixcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Aixcoin
...
New/changed settings (command-line or aixcoin.conf file)
--------------------------------------------------------
