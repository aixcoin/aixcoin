Aixcoin Core version *0.15.2* is now available from:

  <https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in aixcoin-tx (TheBlueMatt)
