Aixcoin Core version 0.9.2.1 is now available from:

  https://aixcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 AIX to 0.01 AIX
...
- Fix "Start aixcoin on system login"
