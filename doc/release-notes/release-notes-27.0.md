Aixcoin Core version 27.0 is now available from:

  <https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-27.0/>
...
- libaixcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libaixcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Aixcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Aixcoin Core would
