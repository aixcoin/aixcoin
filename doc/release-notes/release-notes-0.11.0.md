Aixcoin Core version 0.11.0 is now available from:

  <https://aixcoin.org/bin/aixcoin-core-0.11.0/>
...
For example, add the following to `aixcoin.conf`:
...
Block pruning allows Aixcoin Core to delete the raw block and undo data once 
...
For an example script see [aixcoin-submittx](https://github.com/laanwj/aixcoin-submittx).
...
- #5334 `cf87536` libaixcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new aixcoin-detached-sigs git repo for OSX signatures
...
- #5729 `9c4a5a5` Allow unit changes for read-only AixcoinAmountField
- #5753 `0f44672` Add aixcoin logo to about screen
...
- #5809 `46bfbe7` Add aixcoin-cli man page
...
- #5849 `41259ca` contrib/init/aixcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Aixcoin-Qt.app to Aixcoin-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for aixcoin-tx)
