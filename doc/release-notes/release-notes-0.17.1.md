Aixcoin Core version 0.17.1 is now available from:
  ...
  <https://aixcoin-core.github.io/bin/aixcoin-core-0.17.1/>
...
When aixcoin is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add aixcoin-tx.exe into Windows installer (ken2812221)
