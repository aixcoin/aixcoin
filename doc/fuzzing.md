...
```sh
$ git clone --depth=1 https://github.com/aixcoin-core/qa-assets
...
an instrumentalized libc++, then using it to build [Aixcoin Core dependencies
from source](../depends/README.md) and finally the Aixcoin Core fuzz binary
...
the qa-assets repo
(https://github.com/aixcoin-core/qa-assets/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
Aixcoin Core follows its [security disclosure policy](https://aixcoin-core.github.io/en/security-advisories/),
