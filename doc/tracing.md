...
stap net        inbound_message  0x000000000014419e /src/aixcoind
stap net        outbound_message 0x0000000000107c05 /src/aixcoind
stap validation block_connected  0x00000000002fb10c /src/aixcoind
…
```
...
```
$ readelf -n ./src/aixcoind | grep NT_STAPSDT -A 4 -B 2
