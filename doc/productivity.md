...
```sh
cmake --build build --target aixcoind aixcoin-cli
cmake --build build --target aixcoin-qt
cmake --build build --target bench_aixcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:aixcoin/aixcoin.git
```
...
> e.g. github.com/aixcoin/aixcoin.git or for the GUI github.com/aixcoin-core/gui
