...
Aixcoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Aixcoin Core

**When configuring Aixcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Aixcoin Core:
...
variables will be set when generating the Aixcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
