...
def parse_config_into_aix_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Aixcoin Core {version}\""
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/aixcoin_config.h'), "w", encoding="utf8") as aix_config:
        aix_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='Aixcoin-core msbuild configuration initialiser.')
