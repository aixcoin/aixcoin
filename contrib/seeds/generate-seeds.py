...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef AIXCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define AIXCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the aixcoin network\n')
    ...
    g.write('#endif // AIXCOIN_CHAINPARAMSSEEDS_H\n')
