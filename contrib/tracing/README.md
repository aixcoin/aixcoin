...
```
$ python3 contrib/tracing/p2p_monitor.py ./src/aixcoind
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./src/aixcoind
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./src/aixcoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/aixcoind
```
