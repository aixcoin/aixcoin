...
As of Aixcoin Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/aixcoin-core/guix.sigs/). When
...
builder-keys](https://github.com/aixcoin-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://aixcoin-core.github.io and https://aixcoin.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/aixcoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/aixcoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
