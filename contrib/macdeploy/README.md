...
When complete, it will have produced `Aixcoin-Core.zip`.
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/aixcoin-core/aixcoin-detached-sigs).
