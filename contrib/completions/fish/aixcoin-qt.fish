...
complete --command aixcoin-qt --no-files

# Extract options
function __fish_aixcoinqt_get_options
...
complete \
    --command aixcoin-qt \
    --arguments "(__fish_aixcoinqt_get_options --nofiles)"
