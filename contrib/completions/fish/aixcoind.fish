...
complete --command aixcoind --no-files

# Extract options
function __fish_aixcoind_get_options
...
complete \
    --command aixcoind \
    --arguments "(__fish_aixcoind_get_options --nofiles)"
