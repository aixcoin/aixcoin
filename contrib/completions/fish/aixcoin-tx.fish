...
# Extract options
function __fish_aixcoin_tx_get_options
...
# Extract commands
function __fish_aixcoin_tx_get_commands
...
complete \
    --command aixcoin-tx \
    --condition "not __fish_aixcoin_seen_cmd (__fish_aixcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_aixcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command aixcoin-tx \
    --arguments "(__fish_aixcoin_tx_get_commands)" \
    --no-files
