...
declare -A LIBS
LIBS[cli]="libaixcoin_cli.a"
LIBS[common]="libaixcoin_common.a"
LIBS[consensus]="libaixcoin_consensus.a"
LIBS[crypto]="libaixcoin_crypto.a"
LIBS[node]="libaixcoin_node.a"
LIBS[util]="libaixcoin_util.a"
LIBS[wallet]="libaixcoin_wallet.a"
...
# https://github.com/aixcoin/aixcoin/issues/10102
