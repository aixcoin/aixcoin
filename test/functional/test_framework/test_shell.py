...
class TestShell:
    """Wrapper Class for AixcoinTestFramework.

    The TestShell class extends the AixcoinTestFramework
    ...
    class __TestShell(AixcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AixcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # AixcoinTestFramework instances are supposed to be constructed with the path
