...
# Copyright (c) 2010-present The Aixcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Aixcoin test framework primitive and message structures
...
COIN = 100000000  # 1 AIX in satoshis
...
class CAddress:
    ...
    # see https://github.com/aixcoin/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
    NET_IPV6 = 2
    NET_TORV3 = 4
    NET_I2P = 5
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += (0).to_bytes(4, "little", signed=True)  # Aixcoin Core ignores the version field. Set it to 0.
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in aixcoind
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in aixcoind indicates these should be deserialized as blocks
