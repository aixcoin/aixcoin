...
By default, aixcoind will dump mempool on shutdown and
...
class MempoolPersistTest(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent aixcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
