...
class TransactionTimeRescanTest(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine AIX and create transactions
        ...
        # generate some aix to create transactions and check blockcount
        ...
        # send 10 aix to user's first watch-only address
        self.log.info('Send 10 aix to user')
        ...
        # send 5 aix to our second watch-only address
        self.log.info('Send 5 aix to user')
        ...
        # send 1 aix to our third watch-only address
        self.log.info('Send 1 aix to user')
