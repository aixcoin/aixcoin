...
Verify that a aixcoind node can use an external signer command.
...
class RPCSignerTest(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart aixcoind with -signer=<cmd>',
