...
# The block reward of coinbaseoutput.nValue (50) AIX/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 AIX/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"aixcoin-cli -h\" for help or \"aixcoin-cli listwallets\" to see "
...
class TestAixcoinCli(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `aixcoin-cli getblockchaininfo`")
        ...
        # Prevent aixcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and aixcoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and aixcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (AIX/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 AIX) to the default wallet.
            ...
            # Test aixcoin-cli -generate with -rpcwallet in multiwallet mode.
