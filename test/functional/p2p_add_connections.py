...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The aixcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        # aixcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that aixcoind sends its own version prior to processing
