...
class ConfArgsTest(AixcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        bad_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'aixcoin_bad.conf')
        ...
        with open(os.path.join(self.nodes[0].datadir, 'aixcoin.conf'), 'a', encoding='utf-8') as conf:
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'aixcoin_main.conf')
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "aixcoin.conf")
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_aixcoin.conf")
