...
class TxnMallTest(AixcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 AIX:
        ...
        # First: use raw transaction API to send 1240 AIX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AIX coin each
        ...
        # Node0's balance should be starting balance, plus 50AIX for another
        ...
        # Node0's total balance should be starting balance, plus 100AIX for
