...
class FullBlockTest(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure aixcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure aixcoind isn't accepting b28
        ...
        # aixcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the aixcoin code has custom code which does so);
