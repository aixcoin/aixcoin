...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AixcoinTestFramework
    pass


class ExampleTest(AixcoinTestFramework):
    # Each functional test is a subclass of the AixcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AixcoinTestFramework class so other tests can use it."""
