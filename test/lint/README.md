...
maintained:
* for `src/crc32c`: https://github.com/aixcoin-core/crc32c-subtree.git (branch aixcoin-fork)
* for `src/crypto/ctaes`: https://github.com/aixcoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/aixcoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/aixcoin-core/leveldb-subtree.git (branch aixcoin-fork)
* for `src/minisketch`: https://github.com/aixcoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/aixcoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/aixcoin-core/secp256k1.git
```
