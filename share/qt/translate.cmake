...
function(extract_strings output)
  ...
  file(STRINGS "aixcoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *aixcoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"aixcoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/aixcoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/aixcoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/aixcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/aixcoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/aixcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/aixcoin_en.xlf" aixcoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" aixcoin_en "${aixcoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" aixcoin_en "${aixcoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/aixcoin_en.xlf" "${aixcoin_en}")
