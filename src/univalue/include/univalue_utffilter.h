...
#ifndef AIXCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define AIXCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // AIXCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
