...
#ifndef AIXCOIN_TXGRAPH_H
#define AIXCOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingaixcoin.org/t/introduction-to-cluster-linearization/1032
 *
