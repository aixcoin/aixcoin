...
void AixcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Aixcoin command-line options").arg(PACKAGE_NAME));
...
void AixcoinGUI::setWalletController(WalletController* wallet_controller)
{
...
static bool ThreadSafeMessageBox(AixcoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
