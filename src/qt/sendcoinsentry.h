...
#ifndef AIXCOIN_QT_SENDCOINSENTRY_H
#define AIXCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending aixcoins.
 */
...
#endif // AIXCOIN_QT_SENDCOINSENTRY_H
