...
/** Aixcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AixcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AixcoinUnits(QObject *parent);
...
typedef AixcoinUnits::Unit AixcoinUnit;
