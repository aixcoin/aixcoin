...
#ifndef AIXCOIN_QT_GUIUTIL_H
#define AIXCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Aixcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "aixcoin:" URI into recipient object, return true on successful parsing
