...
/** Interface from Qt to configuration data structure for Aixcoin client.
...
public:
    ...
    AixcoinUnit getDisplayUnit() const { return m_display_aixcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSAIXontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    AixcoinUnit m_display_aixcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(AixcoinUnit unit);
