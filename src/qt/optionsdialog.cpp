      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->aixcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->aixcoinAtStartup);
    ...
    ui->aixcoinAtStartup->setToolTip(ui->aixcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->aixcoinAtStartup->setText(ui->aixcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openAixcoinConfButton->setToolTip(ui->openAixcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AixcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aixcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSAIXontrols);
...
void OptionsDialog::on_openAixcoinConfButton_clicked()
{
