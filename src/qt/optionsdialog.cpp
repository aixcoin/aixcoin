      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->aixcoinAtStartup->setToolTip(ui->aixcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->aixcoinAtStartup->setText(ui->aixcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openAixcoinConfButton->setToolTip(ui->openAixcoinConfButton->toolTip().arg(CLIENT_NAME));
