...
/**
  Aixcoin GUI main class. This class represents the main window of the Aixcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AixcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AixcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AixcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a aixcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, AixcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Aixcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(AixcoinUnit newUnits);
