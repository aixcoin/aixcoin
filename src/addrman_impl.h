...
#ifndef AIXCOIN_ADDRMAN_IMPL_H
#define AIXCOIN_ADDRMAN_IMPL_H
 ...
 * see https://aixcoin-core.github.io/aixcoincore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
