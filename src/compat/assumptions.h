...
#ifndef AIXCOIN_COMPAT_ASSUMPTIONS_H
#define AIXCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Aixcoin cannot be compiled without assertions."
#endif
...
#endif // AIXCOIN_COMPAT_ASSUMPTIONS_H
