...
#ifndef AIXCOIN_ARITH_UINT256_H
#define AIXCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Aixcoin only uses this "compact" format for encoding difficulty
