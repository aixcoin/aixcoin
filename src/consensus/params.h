...
#ifndef AIXCOIN_CONSENSUS_PARAMS_H
#define AIXCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Aixcoin Script solution
...
#endif // AIXCOIN_CONSENSUS_PARAMS_H
