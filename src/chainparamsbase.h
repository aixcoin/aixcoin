// Copyright (c) 2014-2020 The Aixcoin Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between aixcoin-cli and aixcoind)
 * of a given instance of the Aixcoin system.
 */
