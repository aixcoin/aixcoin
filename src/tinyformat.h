...
#include <algorithm>
#include <attributes.h> // Added for Aixcoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Aixcoin Core
#include <util/string.h> // Added for Aixcoin Core
...
// Added for Aixcoin Core. Similar to std::runtime_format from C++26.
...
// Added for Aixcoin Core. Wrapper for checking format strings at compile time.
