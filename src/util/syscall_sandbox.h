...
#ifndef AIXCOIN_UTIL_SYSCALL_SANDBOX_H
#define AIXCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during aixcoind initialization if Aixcoin Core was compiled
...
#endif // AIXCOIN_UTIL_SYSCALL_SANDBOX_H
