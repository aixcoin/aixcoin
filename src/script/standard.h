...
#ifndef AIXCOIN_SCRIPT_STANDARD_H
#define AIXCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a aixcoin address
 */
...
/**
 * Generate a Aixcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // AIXCOIN_SCRIPT_STANDARD_H
