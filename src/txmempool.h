...
#ifndef AIXCOIN_TXMEMPOOL_H
#define AIXCOIN_TXMEMPOOL_H
 ...
 * Aixcoin-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Aixcoin-specific parts of mempool
