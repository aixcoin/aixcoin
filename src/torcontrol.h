// Copyright (c) 2015-2021 The Aixcoin Core developers
 ...
 */
#ifndef AIXCOIN_TORCONTROL_H
#define AIXCOIN_TORCONTROL_H
...
/****** Aixcoin specific TorController implementation ********/
