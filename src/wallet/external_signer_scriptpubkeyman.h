...
#ifndef AIXCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define AIXCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // AIXCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
