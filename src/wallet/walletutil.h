// Copyright (c) 2017-2021 The Aixcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef AIXCOIN_WALLET_WALLETUTIL_H
#define AIXCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! aixcoin from opening the wallet, thinking it was newly created, and
...
#endif // AIXCOIN_WALLET_WALLETUTIL_H
