...
#ifndef AIXCOIN_COMMON_SIGNMESSAGE_H
#define AIXCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's aixcoin address, it must refer to a public key.
...
#endif // AIXCOIN_COMMON_SIGNMESSAGE_H
