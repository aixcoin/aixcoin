...
#ifndef AIXCOIN_COMMON_ARGS_H
#define AIXCOIN_COMMON_ARGS_H
...
extern const char * const AIXCOIN_CONF_FILENAME;
extern const char * const AIXCOIN_SETTINGS_FILENAME;
