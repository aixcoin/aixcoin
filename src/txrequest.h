...
#ifndef AIXCOIN_TXREQUEST_H
#define AIXCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://aixcoin-core.github.io/aixcoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
