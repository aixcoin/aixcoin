 ...
 * for both aixcoind and aixcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <aixcoin-build-info.h>
// The <aixcoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/aixcoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Aixcoin Core copyright is not removed by accident
    if (copyright_devs.find("Aixcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Aixcoin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/aixcoin/aixcoin>";
