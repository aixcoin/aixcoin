// Copyright (c) 2019-2021 The Aixcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef AIXCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define AIXCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@aixcoin.
 *
 ...
 *
 * The chacha20-poly1305@aixcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@aixcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@aixcoin are relatively fast in
...
#endif // AIXCOIN_CRYPTO_CHACHA_POLY_AEAD_H
