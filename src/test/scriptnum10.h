...
#ifndef AIXCOIN_TEST_SCRIPTNUM10_H
#define AIXCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Aixcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // AIXCOIN_TEST_SCRIPTNUM10_H
