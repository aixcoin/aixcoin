...
#ifndef AIXCOIN_INTERFACES_INIT_H
#define AIXCOIN_INTERFACES_INIT_H
...
//! (aixcoin-gui, aixcoin-node, aixcoin-wallet, aixcoind, aixcoin-qt) and each
...
#endif // AIXCOIN_INTERFACES_INIT_H
