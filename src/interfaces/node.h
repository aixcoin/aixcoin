...
#ifndef AIXCOIN_INTERFACES_NODE_H
#define AIXCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a aixcoin node (aixcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or aixcoin.conf.
...
#endif // AIXCOIN_INTERFACES_NODE_H
