...
extern thread_local ThreadContext g_thread_context; // NOLINT(aixcoin-nontrivial-threadlocal)
// Silence nonstandard aixcoin tidy error "Variable with non-trivial destructor
