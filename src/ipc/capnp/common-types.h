...
#ifndef AIXCOIN_IPC_CAPNP_COMMON_TYPES_H
#define AIXCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between aixcoin processes.
...
//! Functions to serialize / deserialize common aixcoin types.
namespace mp {
...
#endif // AIXCOIN_IPC_CAPNP_COMMON_TYPES_H
