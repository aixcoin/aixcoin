...
#ifndef AIXCOIN_BANMAN_H
#define AIXCOIN_BANMAN_H
...
// item in the map. See https://aixcoin-core.github.io/aixcoincore.org/en/2024/07/03/disclose-unbounded-banlist.
